...
public:
	...
	void initialise_xaml_host(std::vector<winrt::Windows::UI::Xaml::Markup::IXamlMetadataProvider> const &);
	//Merges resources with the application's merged resource directory.
	void merge_resources(std::vector<winrt::Windows::UI::Xaml::ResourceDictionary> const &);
...
private:
	...
	std::vector<winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSource> m_sources{};
