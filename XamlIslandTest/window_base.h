...
public:
	...
	std::vector<winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSource> get_xaml_sources();
...
protected:
	...
	HWND create_desktop_window_xaml_source(DWORD extra_styles, const winrt::Windows::UI::Xaml::UIElement &);
...
private:
	...
	void on_take_focus_requested(winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSource const &, winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSourceTakeFocusRequestedEventArgs const &);
	//Got focus event handler. This event (allegedly) fires when the focus changes to a xaml island.
	void on_got_focus(winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSource const &, winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSourceGotFocusEventArgs const &);
	//Obtains which island is to get the focus next.
	winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSource get_next_focused_island(const MSG*);
	...
	std::vector<winrt::Windows::UI::Xaml::Hosting::DesktopWindowXamlSource> m_xaml_sources;
};

//Loads xaml content from a file on the filesystem.
winrt::Windows::UI::Xaml::UIElement LoadControlFromFile(std::wstring const &);
//Loads xaml content from a Windows API resource.
//Resource must be type 255.
winrt::Windows::UI::Xaml::UIElement LoadControlFromResource(uint16_t);