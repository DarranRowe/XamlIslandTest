...
void main_application::initialise_xaml_host(std::vector<wuxm::IXamlMetadataProvider> const &metadata_providers)
{
	std::vector<wuxm::IXamlMetadataProvider> providers;
...
void main_application::merge_resources(std::vector<wux::ResourceDictionary> const &merge_dictionaries)
{
